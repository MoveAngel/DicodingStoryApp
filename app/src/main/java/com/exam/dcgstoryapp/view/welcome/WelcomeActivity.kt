package com.exam.dcgstoryapp.view.welcome
...
import com.exam.dcgstoryapp.databinding.ActivityWelcomeBinding
import com.exam.dcgstoryapp.view.login.LoginActivity
import com.exam.dcgstoryapp.view.signup.SignupActivity
...
class WelcomeActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val desc = ObjectAnimator.ofFloat(binding.descTextView, View.ALPHA, 1f).setDuration(600)
